...
const projects = [

    {
        ...
        image: project1,
        projectLink: "https://www.linkedin.com/posts/tmu-tamil-student-association_tmu-tsa-november-newsletter-activity-7404740080969342976-Qqli?utm_source=share&utm_medium=member_desktop&rcm=ACoAADydPQ0Bes5Z1khKA5lhdXHMKxbpAfeoZnU"
    ...
    return (
        <section id="portfolio" className="py-32 text-white">
            <div className="mx-auto px-4 max-w-7xl grid lg:grid-cols-2 gap-12"> 
                <div>
                    <h2 className="text-6xl font-bold mb-10">Selected <span className="text-blue-300">Projects</span></h2>
                    {projects.map((project) => (
                        ...
                        >
                            ...
                            <h3 className={`text-3xl font-semibold group-hover:text-blue-400 transition-colors 
                                ${selectedProject.id === project.id ? 'text-blue-500' : ''} duration-300`}>{project.title}</h3> {/* selection to change textcolor */}
